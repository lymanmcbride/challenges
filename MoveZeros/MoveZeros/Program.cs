...
namespace MoveZeros
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<object> array = new List<object>() { false, 1, 0, 1, 2, 0, null, 1, 3, "a" };
            ...
            {
                if (array[i] is bool || array[i] is null)//bool converts to 0 or 1, so had to check for this specifically
                {
                ...
                else
                {
                    ...
                    {
                        int int_item = (int)array[i]; //convert from object to int
                        if (int_item == 0)
                        {
